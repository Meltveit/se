      ...
      try {
        ...
        if (businessData) {
          ...
          setFormData({
            ...
            acceptMessages: true, // Default to true if not set
            receiveUpdates: true, // Default to true if not set
        ...
        <Card>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4">
              <h3 className="text-md font-medium text-gray-900">Contact Settings</h3>
            ...
            <div className="space-y-4 pt-4 border-t border-gray-200">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <label htmlFor="acceptMessages" className="font-medium text-gray-700">Accept Messages</label>
                  <p className="text-sm text-gray-500">Allow other businesses to contact you through the platform.</p>
                </div>
                <Switch
                  id="acceptMessages"
                  checked={formData.acceptMessages}
                  onChange={(checked) => handleToggleChange('acceptMessages', checked)}
                />
              </div>
              
              <div className="flex items-center justify-between">
                <div>
                  <label htmlFor="receiveUpdates" className="font-medium text-gray-700">Receive Updates</label>
                  <p className="text-sm text-gray-500">Receive email notifications about platform updates and news.</p>
                </div>
                <Switch
                  id="receiveUpdates"
                  checked={formData.receiveUpdates}
                  onChange={(checked) => handleToggleChange('receiveUpdates', checked)}
                />
              </div>
